 ...
 *
 * AUTHOR  : Kaz Kylheku
 * UPDATE  : $Date: 2009-08-27 14:45:17 +0200 (Do, 27 Aug 2009) $, $Author: strecha $
 *           $Revision: 1382 $
 * PACKAGE : dlabpro/base
 * RCS-ID  : $Id: kzl_hash.h 1382 2009-08-27 12:45:17Z strecha $
 */ 
 ...
 *
 * $Id: kzl_hash.h 1382 2009-08-27 12:45:17Z strecha $
 * $Name$
 */
...
#define KAZLIB_OBSOLESCENT_DEBUG
 ...
 * Notes:
 * 1. 2004-02-24 MWX: User defined context pointer to be passed to user
 *    supplied hash and comparison functions; may be NULL
 */

typedef int (*hash_comp_t)(const void *, const void *, void* /* 1 */);
...
typedef hash_val_t (*hash_fun_t)(const void *, void* /* 1 */);
...
extern hash_t *hash_create(hashcount_t, hash_comp_t, hash_fun_t, void*);
