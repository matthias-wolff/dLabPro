 ...
 *
 */
void data_evaluation_INT16(dataLog log, const char* id, INT16* input, INT32 dim) {
	INT32 i;
...
void data_evaluation_INT32(dataLog log, const char* id, INT32* input, INT32 dim) {
	INT32 i;
	static INT32 local_cnt = 0;
...
void data_evaluation_FLOAT64(dataLog log, const char* id, FLOAT64* input, INT32 dim) {
	INT32 i;
	printf("evaluate");
	static INT32 local_cnt = 0;
...
void data_evaluation_init(dataLog log) {
...
void data_evaluation_free(dataLog log) {
	fclose(log.file);
}
