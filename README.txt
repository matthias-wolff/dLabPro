...
[Setup & Compile]
  ...
  2.3) Set SOURCES to all cpp-Files you want to add to the program.
       (Omit the .cpp extension!)
  ...
  5) If there are "undefined references" consider adding dependend classes.
