 ...
 */
FST_BT_TYPE* CGEN_EXPORT CFst_Sdp_BtInit(FST_TID_TYPE* lpTI, INT32 nGrany)
{
 ...
 */
void CGEN_EXPORT CFst_Sdp_BtDone(FST_BT_TYPE* lpBT)
{
 ...
 */
void CGEN_EXPORT CFst_Sdp_BtStore(FST_BT_TYPE* lpBT, BYTE* lpT, BYTE* lpTprev, INT16 bEps)
{
  INT32 nV = 0;                                                                 /* Vector index                       */
 ...
 */
BYTE* CGEN_EXPORT CFst_Sdp_BtFetch(FST_BT_TYPE* lpBT, INT32 nT)
{
  INT32 nV = 0;                                                                 /* Vector index                       */
  INT32 nE = 0;                                                                 /* Element index in vector            */
 ...
 * @param lpBT Pointer to backtracking tree data struct
 */
void CGEN_EXPORT CFst_Sdp_BtPrint(FST_BT_TYPE* lpBT)
{
 ...
 *              <code>lpSWa</code>).
 */
void CGEN_PRIVATE CFst_Sdp_GetSWeights
(
  CFst*         _this,
  FST_WTYPE*    lpSWa,
  INT32          t,
 ...
 */
void CGEN_PRIVATE CFst_Sdp_ClearLB(CFst* _this, FST_LB_TYPE* lpLB, INT32 nXS)   /* CFst_Sdp_ClearLB ================ */
{
 ...
 */
INT32 CGEN_PRIVATE CFst_Sdp_ExpandState
(
  CFst*         _this,
  FST_TID_TYPE* lpTI,
  FST_WTYPE*    lpSW,
 ...
 */
INT32 CGEN_PRIVATE CFst_Sdp_ExpandLayer
(
  CFst*         _this,
  FST_TID_TYPE* lpTI,
  FST_WTYPE*    lpSW,
 ...
 *
 */
INT16 CGEN_PRIVATE CFst_Sdp_Backtracking
(
  CFst*        _this,
  FST_BT_TYPE* lpBT,
  INT32         nET,
 ...
 */
void CGEN_PRIVATE CFst_Sdp_Order(CFst* _this)
{
 ...
 */
void CGEN_PRIVATE CFst_Sdp_Epsremove(CFst* _this)
{
  INT32      nT     = 0;
  INT32      nIcTis = -1;
  INT32      nIcTos = -1;
 ...
 */
INT16 CGEN_PUBLIC CFst_SdpUnit
(
  CFst*  _this,
  CFst*  itSrc,
  INT32   nUnit,
