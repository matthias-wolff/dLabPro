...
INT16 CFst_AutoRegisterWords(CDlpObject* __this)
{
	...
	REGISTER_FIELD("ic_sd_aux","",LPMV(m_nIcSdAux),NULL,"Internal use: First component of auxiliary state data",FF_HIDDEN | FF_NOSET | FF_NOSAVE,2004,1,"int",(INT32)-1L)
	...
	REGISTER_FIELD("ic_td_aux","",LPMV(m_nIcTdAux),NULL,"Internal use: First component of auxiliary transition data",FF_HIDDEN | FF_NOSET | FF_NOSAVE,2004,1,"int",(INT32)-1L)
